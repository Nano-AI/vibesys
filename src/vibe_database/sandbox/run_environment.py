...
from vibe_database.backends import SandboxKind
from vibe_database.backends.base import ComputeBackendImpl, SetupFn
from vibe_database.constants import DEFAULT_AGENT_BACKEND, PROJECT_ROOT
...
def _cli_container_setup(
    ...
    if effective_agent != "cli" or not request.cli_provider:
        return [], {}
    from vibe_database.agents.cli_docker import (
        DOCKER_PROVIDER_ENV,
