...
Wraps the local ``vibe_database._agent_cli`` compatibility layer, which is backed by
...
5. Reuses :func:`vibe_database.agent_runner._parse_typed_response_text`
...
from vibe_database._agent_cli.base import CodingAgent, MCPServerSpec
from vibe_database._agent_cli.claude import ClaudeCodeCodingAgent
from vibe_database._agent_cli.codex import CodexCodingAgent
from vibe_database._agent_cli.gemini import GeminiCodingAgent
from vibe_database._agent_cli.opencode import OpencodeCodingAgent
from vibe_database.agent_runner import (
...
class CliAgentRunner:
    """:class:`AgentRunner` backed by ``vibe_database._agent_cli`` CLI agents."""
    ...
    def invoke(
        ...
        *,
        ...
        if agent is not None:
            ...
            from vibe_database.agents.docker_executor import DockerCommandExecutor
