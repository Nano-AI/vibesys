...
from vibe_database.loops.plain.render import render_all
from vibe_database.loops.plain.runner_ext import PlainLoopAgentRunner
from vibe_database.prompts import Prompt
...
def run_plain_loop(
    ...
    *,
    ...
    with _RunContext(
        ...
        # See vibe_database/plain/runner_ext.py.
        ...
        while i < end_iteration:
            ...
            while True:
                ...
                # vibe_database/plain/runner_ext.py. The judge may file
