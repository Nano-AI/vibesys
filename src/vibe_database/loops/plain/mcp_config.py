"""Build the :class:`~vibe_database._agent_cli.MCPServerSpec` for the issue tracker.
...
def build_issue_mcp_spec(
    *,
    ...
    The args list is consumed by ``vibe_database.loops.plain.mcp_server``'s
