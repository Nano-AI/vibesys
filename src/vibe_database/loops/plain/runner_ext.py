...
Wraps any :class:`~vibe_database.agents.base.AgentRunner` and injects
...
from vibe_database.loops.plain.tools import build_issue_tools
...
class PlainLoopAgentRunner:
    ...
    def _tracker_kwargs(
        ...
        *,
        ...
        :mod:`vibe_database.loops.plain.tool_impl`, so cap and type-allowlist
