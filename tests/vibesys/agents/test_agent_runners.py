...
class TestCliAgentRunner:
    ...
    def test_cli_runner_text_can_use_a_fresh_session_per_turn(  # noqa: ANN201  # tracked: #288
        self,
        monkeypatch,  # noqa: ANN001  # tracked: #288
        tmp_path,  # noqa: ANN001  # tracked: #288
    ):
        ...
        assert "assistant" not in runner._agents  # noqa: SLF001  # tracked: #288
